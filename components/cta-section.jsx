...
const situations = ['아이디어 단계', '계획서 작성 중', '기존 계획서 보유', '지원사업 준비', '투자 준비', '기타'];
const plans = ['STANDARD', 'PRO', 'PREMIUM', '아직 모르겠음'];

const points = ['시작 방법 안내', '플랜 안내', '지원사업 확인'];
...
export function CTASection() {
  ...
  // TODO: 문의 접수 API 연동 지점. 현재는 랜딩페이지 UI 만 구현되어 있다.
      ...
      <div className={styles.container}>
        <div className={styles.grid}>
          <Reveal>
            ...
            <h2 className={styles.title}>사수래AI 문의</h2>
            <p className={styles.desc}>현재 준비 상황을 알려주세요.</p>
          ...
          <Reveal delay={0.1}>
            <div className={styles.formCard}>
              ...
              <p className={styles.formHint}>확인 후 회신드립니다.</p>
