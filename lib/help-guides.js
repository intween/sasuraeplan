...
export const helpGuides = [
  {
    ...
    title: '처음 시작하기',
    description: '플랜사수를 처음 이용하시나요?\n계획서를 만들거나 업로드하고,\n첫 VC 분석까지 진행하는 방법을 확인하세요.',
    video: {
      title: '2분 만에 플랜사수 시작하기',
      videoUrl: '',
      thumbnail: '',
      duration: '',
    },
    ...
    notices: [
      {
        title: '알아두세요',
        body: ['첫 VC 분석이 완료되면 해당 계획서의 플랜비서를 사용할 수 있습니다.'],
      },
    ],
    nextGuide: { slug: 'plan-assistant', label: '플랜비서 사용법 보기' },
  },

  {
    ...
    steps: [
      ...
      { title: '플랜비서로 이어가세요', description: '궁금한 이유나 보완 방법을 플랜비서에게 바로 물어볼 수 있습니다.' },
    ],
    notices: [
      {
        title: '알아두세요',
...

  {
    ...
    steps: [
      ...
      { title: '수정안을 확인하세요', description: '플랜비서가 계획서에 들어갈 내용을 정리합니다.' },
    ...
    notices: [
      {
        title: '알아두세요',
        body: [
          '플랜비서는 실제 매출, 고객 인터뷰 결과 등 사용자가 제공하지 않은 사실을 임의로 만들어내지 않습니다.',
          '또한 플랜비서가 내용을 작성했다고 자동으로 계획서가 수정되지는 않습니다. 사용자가 ‘계획서에 반영’해야 실제 문서가 변경됩니다.',
        ],
      },
    ],
...

  {
    ...
    sections: [
      {
        title: '지원사업 준비',
        description: '현재 계획서와 지원사업 공고를 비교하고, 부족한 부분을 플랜비서와 보완할 수 있습니다.',
        flow: ['지원사업 선택', '내 계획서로 준비하기', '플랜비서와 보완', '지원사업용 계획서 반영'],
      },
      {
        title: '전문가 피드백',
        description: '전문가 검토 의견을 확인한 뒤, 해당 내용을 플랜비서와 다시 보완할 수 있습니다.',
        flow: ['전문가 피드백 확인', '플랜비서와 보완하기', '계획서 수정'],
      },
    ],
    notices: [
      {
